        ...
        if (element.href.endsWith("/")) {
            ...
            for (let index = 0; index < a_s.length; index++) {
                ...
                if (item.href.endsWith(".mp3")) {
                    ...
                    const fullUrl = `${window.location.origin}/songs/${currSection}/${relativePath}/${encodeURIComponent(relPath)}`;
...
async function getSongs(folder) {
    ...
    for (let index = 0; index < as.length; index++) {
        ...
        if (element.href.endsWith(".mp3")) {
            ...
            songs.push(`${window.location.origin}/songs/${currSection}/${currFolder}/${relativePath}`)
        }
    }
    return songs;
}
